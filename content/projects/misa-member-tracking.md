...
For a student organization as large as MISA (Ateneo Management Information Systems Association), simple administrative tasks were becoming a huge operational headache. The existing process for tracking members was scattered and manual. Keeping a single, up-to-date database of 550+ students was tough enough, but accurately tracking who attended which events was even harder.
...
- Responsive front-end interface optimized for tablet and laptop use
- Real-time database synchronization
- Efficient data structure for handling 550+ member records
- User-friendly interface designed for Operations Managers
- Scalable architecture to support future organizational growth

## Lessons Learned

- Working effectively in a cross-functional team with designers, PMs, and other developers
- Balancing technical feasibility with design requirements
- Building systems that need to handle real-world organizational workflows
- Creating user interfaces that are intuitive for non-technical users
- Managing project scope and ensuring long-term maintainability
